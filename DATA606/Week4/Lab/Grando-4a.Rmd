...
Both samples appear to have the same general mean and distribution.  The more samples we take, the more accurate our estimate will become because we will have a better overall picture of the population data.
...
Each element represents a simple random sample of size 50 from the vector "area".
...
The center stays relatively the same, but gets closer to the population mean, as the number of samples increase; however, the spread decreases as the number of samples increase.
