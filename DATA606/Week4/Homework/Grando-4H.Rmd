...
The p-value is based on determining a z-value from the sample distribution.  This calculation takes the square root of the sample size in the denominator; therefore, an increase in n would result in a decrease of the absolute value of Z.  The overall result would be an increase in the p-value.

put equation in here

```{r}
z_value <- qnorm(p = .08, mean = 0, sd = 1)
z_value_new <- z_value * sqrt(50) / sqrt(500)
p_value <- pnorm(q = z_value_new, mean = 0, sd = 1)
```
