...
2. success-failure condition: The number of successes (affirmatives) are `r ns*p_hat` and failures (negatives) are `r ns*(1-p_hat)`.  The minimum number of successes and failures have been met.
