...
The number of successes (atheist) are `r nrow(us05_atheist)` and failures (non-athiest) are `r nrow(us05)` for the 2005 data.  The number of successes (atheist) are `r nrow(us12_atheist)` and failures (non-athiest) are `r nrow(us12)` for the 2012 data.  The minimum number of successes and failures have been met.
