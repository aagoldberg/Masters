...
Now, we can see if gross floor area is a good predictor of the time it takes fora project to certify.
...
In order to validate the models, the following asusmptions must be checked:
